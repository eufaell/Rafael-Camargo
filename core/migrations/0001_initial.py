# Generated by Django 5.0.7 on 2024-07-27 00:28
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('mar_name', models.CharField(max_length=255, unique=True, verbose_name='Marca da Camisa:')),
                ('slug', models.SlugField(blank=True, max_length=255, unique=True)),
            ],
            options={
                'verbose_name': 'Marca',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='images/produto', verbose_name='Imagem da Capa')),
                ('slug', models.SlugField(blank=True, max_length=255, unique=True)),
